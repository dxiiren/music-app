...
Write-Host ""
Write-Host "Music App Bootstrap Setup" -ForegroundColor Cyan
...
Write-Host "  2. Start the dev server (:8115):  just start   (foreground: just dev)" -ForegroundColor Gray
