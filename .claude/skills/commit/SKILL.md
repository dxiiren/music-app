...
| Changed paths                                          | scope               |
| ------------------------------------------------------ | ------------------- |
| `src/components/Upload.vue`, `src/components/CompositionItem.vue` | `manage` |
| `src/components/AppPlayer.vue`, `src/stores/player.js` | `player`            |
| `src/components/Auth/`, `src/components/AppAuth.vue`, `src/stores/user.js` | `auth` |
| `src/views/`, `src/router/`, `src/App.vue`             | `views` / `router`  |
| `src/includes/`, `src/directives/`, `src/stores/`      | `includes`          |
| `src/locales/`, `src/includes/i18n.js`                 | `i18n`              |
...
scope: manage, player, auth, views, router, includes, i18n, styles, config, tooling, docs, skills
```
...
- Ported from akmal-resume-website for music-app: same fast-path/scoped pipeline;
